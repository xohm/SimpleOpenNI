...
//	}
    ...
    private void setupUser()
    {
        ...
        _userImage = new PImage(userWidth(), userHeight(),PConstants.RGB);
    }
...
/*
                float[] depth3dArray = depthMapRealWorldA();
                int index=0;
                for(int i=0;i < _depthMapRealWorld.length;i++)
                {
                    _depthMapRealWorld[i].set(depth3dArray[index++],
                                              depth3dArray[index++],
                                              depth3dArray[index++]);
                }
*/
                ...
                for(int i=0;i < _depthMapRealWorld.length;i++)
		{
                    _depthMapRealWorld[i].set(_depthMapRealWorldXn[index++],
                                              _depthMapRealWorldXn[index++],
                                              _depthMapRealWorldXn[index++]);
		}
    ...
    */
    public void drawLimb(int userId, int joint1, int  joint2)
    {
        ...
        _parent.line(joint1Pos2d.x, joint1Pos2d.y,
...
//	*/
    ...
    */
    ...
    public void calcUserCoordsys(PMatrix3D mat)
    {
      ...
      mat.set(matRet[0], matRet[1], matRet[2], 0,
              matRet[3], matRet[4], matRet[5], 0,
              matRet[6], matRet[7], matRet[8], 0,
              0, 		0, 			0, 			1);
    }
...
/*
	...
	{
		try {
                        _createHandsMethod.invoke(_handCbObject, new Object[] { (int)nId,new PVector(pPosition.getX(),pPosition.getY(),pPosition.getZ()),fTime});
		} 
		catch (Exception e) 
		{}	
	}	
	...
	{
		try {
                        _updateHandsMethod.invoke(_handCbObject, new Object[] { (int)nId,new PVector(pPosition.getX(),pPosition.getY(),pPosition.getZ()),fTime});
		} 
		catch (Exception e) 
		{}	
	}	
